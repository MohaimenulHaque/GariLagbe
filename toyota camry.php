                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            if (isset($_SESSION['s_name'])) {
                                echo '<a href="booking.php" class="btn btn-success" style =" padding: 10px;"><h3>BOOK THE CAR</h3> </a>';
                            } else {
                                echo '<a href="login.php" class="btn btn-success" style =" padding: 10px;"><h3>BOOK THE CAR</h3> </a>';
                            }
                            ?>
                        </div>
